  ...
  [6],
  {
    SqBY: function(e, t, n) {
      ...
      var f = d.h.colors,
        u = d.h.fontSizes,
        h = d.h.fonts,
        v = Object(p.c)(d.d).withConfig({
          displayName: 'pensieve__StyledMainContainer',
          componentId: 'sc-1bm8or0-0',
        })(
          [
        ...
        x = p.c.div.withConfig({
          displayName: 'pensieve__StyledPostInner',
          componentId: 'sc-1bm8or0-2',
        })(
          [
            '',
            ';',
        ...
        b = p.c.div.withConfig({
          ...
          componentId: 'sc-1bm8or0-4',
        })(['', ';margin-bottom:30px;'], d.g.flexBetween),
        E = p.c.div.withConfig({
          displayName: 'pensieve__StyledFolder',
          componentId: 'sc-1bm8or0-5',
        })(['color:', ';svg{width:40px;height:40px;}'], f.green),
        _ = p.c.h5.withConfig({
          displayName: 'pensieve__StyledPostName',
          componentId: 'sc-1bm8or0-6',
        })(['margin:0 0 10px;font-size:', ';color:', ';'], u.xxl, f.lightestSlate),
        S = p.c.div.withConfig({
          displayName: 'pensieve__StyledPostDescription',
          componentId: 'sc-1bm8or0-7',
        })(['font-size:17px;color:', ';'], f.lightSlate),
        k = p.c.span.withConfig({
          displayName: 'pensieve__StyledDate',
          componentId: 'sc-1bm8or0-8',
        })(
        ...
        N = p.c.ul.withConfig({ displayName: 'pensieve__StyledTags', componentId: 'sc-1bm8or0-9' })(
          [
      ...
      t.default = function(e) {
        ...
        return i.a.createElement(
          ...
          i.a.createElement(
            o.Helmet,
            null,
            i.a.createElement('title', null, 'Pensieve | David Sullivan'),
            i.a.createElement('link', { rel: 'canonical', href: 'https://dsully.dev/pensieve' }),
          ),
          i.a.createElement(
            v,
            null,
                        ...
                        i.a.createElement(
                          ...
                          i.a.createElement(
                            ...
                            i.a.createElement(
                              b,
                              null,
                              i.a.createElement(E, null, i.a.createElement(m.p, null)),
                            ),
...
//# sourceMappingURL=component---src-pages-pensieve-index-js-2ac0337786818a3abd01.js.map
